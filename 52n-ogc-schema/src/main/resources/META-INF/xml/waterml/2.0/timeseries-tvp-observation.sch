...
<schema fpi="http://schemas.opengis.net/waterml/2.0/interleaved_timeseries_observation.sch" see="http://www.opengis.net/spec/waterml/2.0/req/xsd-timeseries-tvp-observation"
  ...
  <p>Verifies that the OM_Observation result type is valid according to the WaterML2 interleaved timeseries observation . Tests
    requirements from http://www.opengis.net/spec/waterml/2.0/req/xsd-timeseries-tvp-observation</p>
  ...
  <pattern id="result">
    ...
    <rule context="//om:OM_Observation/om:result">
      <assert test="schema-element(wml2:Timeseries)">result must contain an element in the substitution group headed by wml2:Timeseries</assert>
    </rule>
  </pattern>
