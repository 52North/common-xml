OpenGIS(r) SWE Common schema - ReadMe.txt
=========================================
...
The SWE Common 2.0 standard is defined in OGC document 08-094r1.
...
SWE Common 2.0 is swe.xsd.

* Latest version is: http://schemas.opengis.net/sweCommon/2.0/swe.xsd *
...
2011-01-06  Alexandre Robin
  ...
  * v2.0.0: Added sweCommon/2.0 - OGC 08-094r1
